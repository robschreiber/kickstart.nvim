...
vim.opt.shellcmdflag =
  '-NoLogo -NoProfile -ExecutionPolicy Unrestricted -Command [Console]::InputEncoding=[Console]::OutputEncoding=[System.Text.Encoding]::UTF8;'
...
-- Keep the cursor where you want it
    ...
    config = function()
      ...
      statusline.config.content.active = function()
        ...
        return MiniStatusline.combine_groups {
          ...
          { hl = 'MiniStatuslineDevinfo', strings = { git, diagnostics, arrow } },
